...
export default function Footer() {
  return (
    <section className="bg-disabled pt-16 pb-6 px-3">
      <div className='border-b border-[#D2D2D5]'>
        <div className="container mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10 md:gap-2 lg:gap-10 items-start justify-between py-10">
          <div>
            ...
            <div className='pt-3'>
              <h3>AZ Licencse: #19444000</h3>
            <h3>NV License: #4046335</h3>
            </div>
          </div>
